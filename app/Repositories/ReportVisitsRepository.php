        ...
        try {
            ...
            if ($BeneficiariesReport->status_id == 1) {
                ...
                $data = [
                    ...
                    "identiti_type" => $BeneficiariesReport->type_document == "TI" ? "Tarjeta de identidad" : ($BeneficiariesReport->type_document == "CC" ? "Cedula de ciudadania" : ($BeneficiariesReport->type_document == "NIT" ? "Número de Identificación Tributaria" : ($BeneficiariesReport->type_document == "PEP" ? "Permiso Especial de Permanencia" : ($BeneficiariesReport->type_document == "RC" ? "Registro Civil" : "NO REGISTRADA")))),
                    ...
                    //tipos de sange
                    "TipS" => $BeneficiariesReport->blood_type == 1 ? "A+" : ($BeneficiariesReport->blood_type == 2 ? "A-" : ($BeneficiariesReport->blood_type == 3 ? "B+" : ($BeneficiariesReport->blood_type == 4 ? "B-" : ($BeneficiariesReport->blood_type == 5 ? "AB+" : ($BeneficiariesReport->blood_type == 6 ? "O+" : ($BeneficiariesReport->blood_type == 7 ? "O-" : ($BeneficiariesReport->blood_type == 8 ? "AB-" : ""))))))),
                    //zona
                    ...
                    "OTHER_ET" => $BeneficiariesReport->ethnicities_id == 12 ? $BeneficiariesReport->ethnicitie?->name : "",
                    //discapacidad
