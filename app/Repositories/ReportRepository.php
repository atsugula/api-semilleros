...
class ReportRepository
{
    ...
    public function exportPecs($request)
    {
        try {
            ...
            report($ex);
            return response()->json(['error' => 'Error obteniendo el dato', 'success' => false], 500);
        }
    }
    ...
    public function exportLoginAccess($request)
    {
        try {
            ...
            report($ex);
            return response()->json(['error' => 'Error obteniendo el dato ' . $ex->getMessage(), 'success' => false], 500);
        }
    }
    ...
    public function exportBeneficiaries($request)
    {
        try {
            ...
            report($ex);
            return response()->json(['message' => 'Error obteniendo el dato', 'success' => false], 500);
        }
    }
