...
// Route::get('config-clear', function () {
    ...
    route::post('/consultas', [PDFController_V1::class, 'consultas']);

    Route::get('dark-mode-switcher', [PlantillaController::class, 'switch'])->name('dark-mode-switcher');
    Route::get('color-scheme-switcher/{color_scheme}', [PlantillaController::class, 'switchColor'])->name('color-scheme-switcher');
    ...
    Route::controller(PlantillaController::class)->middleware('loggedin')->group(function () {
        Route::get('login', 'loginView')->name('login.index');
        Route::post('login', 'login')->name('login.check');
    });

Route::middleware('authblade')->group(function() {
    Route::get('logout', [PlantillaController::class, 'logout'])->name('logout.web');
